...
There are many subject options but so far the only implemented option is Chemistry. Once the user clicks the subject of their choice they will be able to learn topics from the chosen subjedct.
Prototype features very basic subject selection.
[https://project-project-7.vercel.app/](https://project-project-7.vercel.app/)
